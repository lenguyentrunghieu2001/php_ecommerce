                    ...
                    ?>
                        ...
                        ?>
                            <form action="<?= route_cart ?>/addcart" method="POST">
                                ...
                                <input type="hidden" name="product_name" value="<?= $product_new['name'] ?>">
                                <input type="hidden" name="product_image" value="<?= $product_new['image'] ?>">
                                <input type="hidden" name="product_price" value="<?= $product_new['price'] ?>">
                                <input type="hidden" name="product_quantity" value="1">
                                <div class="grids">
                                    <div class="grids_in">
                                        <div class="content">
