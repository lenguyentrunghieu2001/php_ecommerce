            ...
            <div class="footer footer_bottom">
                ...
                <div class="footer-col">
                    ...
                    <div class="footer-col-content">
                        <ul class="social">
                            <li>
                                <a href="#" class="fb"><img src="<?= asset ?>/image/Fb.png">Facebook</a>
                            </li>
                            <li>
                                <a href="#" class="fb"><img src="<?= asset ?>/image/Gg.png">Google</a>
                            </li>
                        </ul>
                        <div class="clear"></div>
                    </div>
                        ...
                        <ul class="icon_list">
                            <li>
                                <a href=".">
                                    ...
                                    <p class="text_li">
                                        <span class="phone_footer">Hotline: 0363-151-035</span>
                                        <span class="text_small">(Từ 8h đến 20h tất cả các ngày)</span>
                                    </p>
                                </a>
                            </li>
                            <div class="clear"></div>
                            <li><a><i class="fa fa-envelope" aria-hidden="true"></i>lenguyentrunghieu2001@gmail.com</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<script defer type="text/javascript" src="<?= asset ?>/scripts/shop/sweet-alert.js"></script>
<script defer type="text/javascript" src="<?= asset ?>/scripts/shop/bootstrap.js"></script>
<script defer type="text/javascript" src="<?= asset ?>/scripts/shop/jquery.flexslider-min.js"></script>
<script defer src="<?= asset ?>/scripts/shop/owl.carousel.min.js" type="text/javascript"></script>
<script defer src="<?= asset ?>/scripts/shop/owl.carousel.js" type="text/javascript"></script>
<script defer src="<?= asset ?>/scripts/shop/jquery.lazyload.min.js" type="text/javascript"></script>
<script defer type="text/javascript" src="<?= asset ?>/scripts/shop/script_ex.js"></script>
<script defer type="text/javascript" src="<?= asset ?>/scripts/shop/script_menu.js"></script>
...
<link async rel="stylesheet" href="<?= asset ?>/css/shop/cssfooter.css" />
