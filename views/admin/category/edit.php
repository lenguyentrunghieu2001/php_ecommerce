...
<div class="container">
    ...
    <form action="" method="POST">
        <div class="mb-3">
            ...
            <textarea class="form-control" id="description_category" aria-describedby="emailHelp" placeholder="placeholer description ..." name="description" cols="30" rows="10"><?= isset($_POST['description']) ? $_POST['description'] : $category_id['description'] ?></textarea>
            <?php
